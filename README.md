...
- **সিঙ্গেল-সাইকেল রোটেশন:** ৩2-বিট `ror eax, cl` ইনস্ট্রাকশন ইমিটার (`রোটেট_ডানে_৩২` / `ror32`)।
...
| **সিপিইউ ইন্সট্রাকশন সেট** | x86_64 Direct Machine Code (ALU, SSE2 SIMD, RDTSC, RDRAND, ROR, Syscalls) | ✅ সিলিকন হার্ডওয়্যার |
| **স্বয়ংক্রিয় টেস্ট সুইট** | ১৯ / ১৯ টি টেস্ট সফলভাবে উত্তীর্ণ (`./bin/lipic test`) | ✅ ১০০% পাস |
