...
1. **x86_64 (AMD64) ELF64 Emitter:** [`src/compiler/elf_emitter.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/src/compiler/elf_emitter.lp)
2. **ARM64 (AArch64) ELF64 Emitter:** [`src/compiler/arm64_emitter.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/src/compiler/arm64_emitter.lp)
...
The WebAssembly emitter ([`src/compiler/wasm_emitter.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/src/compiler/wasm_emitter.lp)) translates Lipi procedures directly into W3C WebAssembly 1.0 binary modules (`.wasm`) for execution in browsers, edge workers, and sandboxed runtimes (0% C, 0% LLVM, 0% Emscripten):
...
In [`src/compiler/elf_emitter.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/src/compiler/elf_emitter.lp#L326-L338):
```lipi
...
Lipi 2.0 eliminates all legacy external web frameworks and C wrappers in favor of a sovereign, high-throughput standard web engine: [`std/web.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/std/web.lp).
...
[`std/thread.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/std/thread.lp) invokes the Linux `SYS_clone` syscall (56 on x86_64, 220 on AArch64):
- **Clone Flags:**
...
[`std/arena.lp`](file:///home/shafiullah/Documents/file/work/oshim-framework/std/arena.lp) implements linear bump allocation for high-throughput pipelines:
